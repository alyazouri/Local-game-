// JO-HARD-MODE PAC — DAY VERSION (نهاري)
// هدف: أعلى احتمال للّوبي/الماتش الأردني، مع استقرار عالي في النهار.
// STRICT_BLOCK = false → أي وجهة مش أردنية برضه بتمشي عبر البروكسي الأردني.
...
// النهاري: لا نحظر غير الأردني، نمشيه برضه على البروكسي
var STRICT_BLOCK = false; // true = حظر الوجهات غير الأردنية، false = تمريرها عبر البروكسي

//================== بادئات IPv6 الأردنية — من الأكبر للأقل ==================//
var JO_V6_BASE = [
  // ========= نطاقات 2a00:18dc / 18da / 18d9 =========
  "2a00:18dc::/30",
  "2a00:18da::/31",
  "2a00:18d9::/32",
...
// نفس القائمة لكل الفئات (لوبي، ماتش، ريكروت، أبديت، CDN)
var JO_V6_PREFIX = {
  LOBBY: JO_V6_BASE,
  MATCH: JO_V6_BASE,
  RECRUIT_SEARCH: JO_V6_BASE,
  UPDATES: JO_V6_BASE,
  CDN: JO_V6_BASE
};
...
// قرار الفئة: دايماً نرجّع بروكسي (أردني) حتى لو الوجهة مش أردنية
...
function FindProxyForURL(url, host){
  ...
  // لو جهازك أو البروكسي ليسا "OK" حسب السياسة → حظر شامل (أمان)

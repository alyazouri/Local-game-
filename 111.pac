// JO-HARD-MODE PAC — v7 (strict, optimized, hardened, lobby-focused)
...
function FindProxyForURL(url, host){
  ...
  // دفشة زيادة: أي هوست فيه pubg / igamecj / proximabeta نعتبروه LOBBY/SOCIAL
  if(host && (host.indexOf("pubg") !== -1 ||
  ...
  // 2) LOBBY + RECRUIT/SEARCH + SOCIAL/FRIENDS/CLAN
